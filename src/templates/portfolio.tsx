      ...
      <div className="md:px-4 mt-12 py-6 md:w-11/12 mx-auto">
        <div className="mx-auto relative">
          ...
          <div className="flex items-center justify-center relative lg:absolute w-full h-full top-0 left-0">
            ...
            <div
              className="px-4 py-8 lg:p-0 relative z-10 text-center text-color-default lg:text-white bg-bgalt lg:bg-transparent"
            >
              <h1 className="text-5xl font-bold text-color-1 lg:text-white">{data.mdx.frontmatter.title}</h1>
              <p className="mt-1 flex items-center justify-center">
                <MapPin /> <span className="ml-2">{data.mdx.frontmatter.address}</span>
              </p>
